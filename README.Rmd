...
Most of the functions split/expand a `vector`, `list` or `data.frame`.  The `combine`, `duration`, & `mtabulate` functions are notable exceptions.  The table below describes the functions and their use:
